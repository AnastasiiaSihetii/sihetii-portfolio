...
export const designEngineer2026En = {
  ...
  blocks: [
    ...
    p(<>Courses are appearing alongside. <a href="https://volomydyr.com/" target="_blank" rel="noopener">Volodymyr Merlenko</a> from Cieden released a Design Engineer plugin for Claude Code, access for a donation to the KOLO foundation. <a href="https://prjctr.com/course/build-your-startup-with-ai" target="_blank" rel="noopener">Projector</a> is launching &laquo;Build Your Startup with AI&raquo;.</>),
