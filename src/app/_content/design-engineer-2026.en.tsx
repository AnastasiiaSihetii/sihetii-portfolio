...
export const designEngineer2026En = {
  ...
  metaDescription:
    "A study of the design engineer role on 2026 data. Global openings with salary ranges, a consolidated requirements profile, a text analysis of 250 design vacancies on DOU, and the route in from product design.",
  ogTitle: "Design Engineer in 2026: a study of the role",
  ogDescription:
    "Global openings at Anthropic, Vercel, Cursor and Ramp, a requirements profile, and a deep cut of the Ukrainian market across 250 DOU vacancies.",
  ...
  lead: [
    ...
    "I compared the global market with the Ukrainian one. The global market sets the standard: who hires, what they ask for, what they pay, how they interview. And the Ukrainian one: what the text of 408 design and 146 front-end vacancies from DOU and Djinni actually shows. How much designers earn against developers, who already works in this role, and how I looked for that work myself. At the end there is a consolidated list of requirements for the profession and conclusions about what to do with all of it. I did this research with the help of the Claude Fable 5 model.",
  ],
  ...
  blocks: [
    p("My name is Nastia. I am a product designer with more than five years of experience building interfaces for agencies, startups and enterprise products. I am moving into design engineering now, and I already combine design with front-end work on a commercial project."),
    p("Contents"),
    ol(
    ...
    p("A design engineer works where product design meets the front end, and what they hand over is different from what a designer hands over. A designer delivers a mockup and a description of states, which a developer then builds. A design engineer delivers a finished component in the codebase: with its states, animation, accessibility and behaviour across screens. There are no intermediate artefacts for handoff in this work, because there is nobody to hand off to. Hence the words job posts use for the role: ownership, craft, and a senior bar."),
    ...
    p("Producing an interface got cheaper, because an agent generates a component in minutes. Design did not get cheaper along with it: for 80% of designers AI helps but does not replace their own sense of quality and the final polish, and only 5% of managers came to value execution quality less. Half of hiring managers now weigh AI fluency more heavily when hiring designers."),
    ...
    p(<>Online I came across several boards that collect vacancies specifically for design engineers. Let us take <a href="https://www.designengineerjob.com/" target="_blank" rel="noopener">designengineerjob.com</a> as an example, together with company career pages, a snapshot at the end of August 2026, web and product roles. These are openings at Anthropic, Vercel, Cursor, Replit, Ramp, Lovable, Supabase, Runway, Cloudflare, Airtable, Meta and others. The vacancy texts were analysed by the Claude Fable 5 model. The geography is mostly American, San Francisco and New York. Europe is represented by Lovable out of Stockholm, and even there candidates in New York get priority. About half the listings on the board are dated May, the rest mostly April, so the snapshot does not give a full picture of the market, but it is enough ground to understand the position.</>),
    fig(
    ...
    p(<>A <a href="https://jobs.dou.ua/vacancies/?search=design+engineer" target="_blank" rel="noopener">search for &laquo;design engineer&raquo; on DOU</a> returns 39 vacancies. Almost all of them are design engineers in the hardware sense, from miltech: UAVs, electronics, RF systems. Two are on-topic: Cracken, with Design Engineer in the title, and Cieden, where the role hides under &laquo;UX Designer&raquo;. There is still no separate &laquo;Design Engineer&raquo; category on DOU or on <a href="https://djinni.co/jobs/" target="_blank" rel="noopener">Djinni</a>.</>),
    p(<>A <a href="https://djinni.co/jobs/?all_keywords=design+engineer" target="_blank" rel="noopener">search for &laquo;design engineer&raquo; on Djinni</a> gives 59 vacancies, but only one is on-topic: <a href="https://djinni.co/jobs/844161-product-design-engineer/" target="_blank" rel="noopener">DOOR3</a>, an American company that opened a remote Product Design Engineer position on 20 August with the phrasing &laquo;one craft, not two stages with a handoff between them&raquo;. But the country field says EU, so with a &laquo;Ukraine&raquo; profile you cannot apply.</>),
    p("The sample: every vacancy listed on DOU on 25.08.2026 in the Design (250) and Front End (88) categories, and every Djinni vacancy in the Design, Product Design, Graphic Design, UI/UX and UX Research categories (158 unique) and JavaScript and React.js (58). A script downloaded the full text of each one and searched it for keywords: tool and technology names, the word AI in all its forms, and phrasing about code. \"A design engineer in substance\" cannot be counted that way, so the script shortlisted candidates by the words design engineer and \"code\" in the description, and after that they were read by eye and only those kept where one person both designs the interface and takes it to code, rather than merely \"understands the front end\". Vacancies listed on both sites were not deduplicated: within the 408 they are counted twice."),
    stats(
      { value: "4 of 408", label: "design vacancies on DOU and Djinni ask for a design engineer in substance: design and code in one role" },
      { value: "37 of 408", label: "mention Claude, another 17 Cursor, 9 v0 or Bolt, 4 Lovable. AI as a tool for code appears in 9% of descriptions" },
      { value: "214 of 408", label: "contain the word AI in some form. Half the market already writes about AI, but mostly as image generation" },
    ),
    p("React is mentioned by 18 design vacancies out of 408, TypeScript by 4, HTML and CSS by 50, Storybook by 6. So code as a requirement for a designer appears in 4% of descriptions. For comparison, across 146 front-end vacancies Claude is mentioned by 20, and one asks outright for \"Figma skills with a design engineer mindset\". The role is growing from both sides: front-end developers get Claude added to their requirements more often than designers do, 14% against 9%, and designers get code added to theirs. But vacancies where both requirements converge into one role are around one percent from either side. For a front-end developer the way into the role runs not through tools but through craft: in the consolidated profile below, Figma, typography and motion stand level with React."),
    p(<>On Djinni 110 design vacancies out of 158 are fully remote; on DOU only 8 out of 250. The one trainee vacancy: <a href="https://djinni.co/jobs/820758-trainee-ux-ui-engineer/" target="_blank" rel="noopener">jito.dev is looking for a Trainee UX/UI engineer</a>, an intern who will work with Claude Code and Storybook in order to &laquo;understand and fix the front end&raquo; behind their own mockups. From the description: &laquo;You shouldn&#39;t fear that AI will take your job; you should be the one who uses AI to do the work of three people&raquo;. That vacancy has 202 applications: there are far more people wanting into the role than there are seats.</>),
    fig(
    ...
    p(<>Courses are appearing alongside. <a href="https://volomydyr.com/" target="_blank" rel="noopener">Volodymyr Merlenko</a> from Cieden released a Design Engineer plugin for Claude Code, access for a donation to the KOLO foundation. At Code w/ Claude 2026 Anthropic showed in the talk <a href="https://www.youtube.com/watch?v=Uvl-tRga98g" target="_blank" rel="noopener">&laquo;Designing with Claude: From prompt to production&raquo;</a> how a small team built Claude Design from prompt to production. <a href="https://prjctr.com/course/build-your-startup-with-ai" target="_blank" rel="noopener">Projector</a> is launching &laquo;Build Your Startup with AI&raquo;, and <a href="http://web.archive.org/web/20260117192300/https://neoversity.com.ua/product-design-m" target="_blank" rel="noopener">Neoversity</a> had a master&#39;s programme with UX and front end in one curriculum, though the page for it is no longer on their site.</>),

    h3("", "How I looked for work as an engineer"),
    p("There really are few vacancies with \"design engineer\" in the title, as you can see. So I started with the good old method and wrote to people I had worked with before. I asked whether they or anyone they knew had a task that needed a design engineer specifically. That is how I found the project I have been running for two months now. But a project has an end, and the search for full-time work is still ahead."),
    ...
    ul(
      ...
      "Domain experience: fintech, B2B SaaS, insurance.",
    ...
    ul(
      ...
      "Docker, WebSockets, back end. That is a full-stack developer with a sense of design.",
      ...
      "Moving the whole team onto an AI process. That is a leadership role with different pay.",
    ),
    p("If most of the points in a design engineer vacancy belong to this third group, what you have in front of you is a different position under a familiar name."),
    ...
    p(<>A design engineer&#39;s portfolio is their own site, made by themselves, with their own interactions. Then their own components. Those need empty states, error states and accessibility built in from the start. <a href="https://uithings.com/design-engineering" target="_blank" rel="noopener">The Complete Guide to Design Engineering</a> advises showing them in a public Storybook with documentation. And a commit history that shows how you worked the details out.</>),

    sep(),
    h2("summary", "In summary"),
    ul(
      "The market talks about AI more than it hires for it. In Ukraine half of design vacancies mention AI, 9% ask for Claude or Cursor, 4% React, and only 1% is looking for a design engineer in substance. Vacancies already ask for a designer with engineering skills, but a separate position and category for it has not appeared yet.",
    ...
    ul(
      ...
      "Turn your portfolio into links: your own site, your own components with states, a Storybook, a commit history.",
    ...
    ol(
      ...
      <><a href="https://jobs.dou.ua/vacancies/?search=design+engineer" target="_blank" rel="noopener">DOU Jobs: search for &laquo;design engineer&raquo;</a>, plus a full text analysis of 250 vacancies in the Design category and 88 in Front End (snapshot 25.08.2026)</>,
      ...
      <><a href="https://volomydyr.com/" target="_blank" rel="noopener">Volodymyr Merlenko: the Design Engineer plugin for Claude Code</a>; <a href="https://www.youtube.com/watch?v=Uvl-tRga98g" target="_blank" rel="noopener">Anthropic, Dan Cary: Designing with Claude: From prompt to production</a> (Code w/ Claude 2026, London, 19.05.2026); <a href="https://prjctr.com/course/build-your-startup-with-ai" target="_blank" rel="noopener">Projector: Build Your Startup with AI</a>; <a href="http://web.archive.org/web/20260117192300/https://neoversity.com.ua/product-design-m" target="_blank" rel="noopener">Neoversity: HCI &amp; Design for the AI era</a> (archived copy)</>,
