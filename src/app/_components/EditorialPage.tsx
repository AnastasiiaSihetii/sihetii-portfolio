  ...
  const heroShot = hero ? (
    ...
    >
      {/* Кадр статті — різкий моноширинний текст, тому дефолтна якість 75 його
          помітно розмиває. І свідомо без sizes: із ним браузер обирав кандидата
          840px на слот 1080px і розтягував його, тобто саме те розмиття, яке
          тут виправляємо. Без sizes оптимізатор віддає повну ширину. */}
      <Image
        src={hero.src}
        alt={hero.alt}
        width={hero.width}
